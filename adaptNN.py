...
def main():
	...
	while (True):
		...
		if not sys.stdin.isatty():
			...
			train_x, prediction, network_cost, network_output, param_cost = net.train_batch(train_data, learning_rate1=1.5, learning_rate2=1.5, mod = modify, batch_size=batch_size)
