...
def main():
	...
	while (True):
		...
		if not sys.stdin.isatty():
			...
			train_x, prediction, network_cost, network_output, param_cost = net.train_batch(train_data, learning_rate1=2.5, learning_rate2=0.003, mod = modify, batch_size=batch_size)
