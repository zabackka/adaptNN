...
def main():
	...
	# build NN structure
	layers = []
	input_layer = FullyConnectedLayer(num_params, num_params, activation=nnet.sigmoid)
	...
	while (True):
		...
		if not sys.stdin.isatty():
			...
			train_x, prediction, param_cost = net.train_batch(train_data, learning_rate1=2.3, learning_rate2=1.5)
...
class FullyConnectedLayer(object):
	...
	def input_cost(self, net):
		return T.mean(T.pow((net.performance_goal - self.output), 2))
